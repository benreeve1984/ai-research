...
class TestLoadConfig:
    ...
    def test_load_config_with_secrets_manager(self, mock_session):
        ...
        mock_secrets_client.get_secret_value.return_value = {
            'SecretString': '{"OPENAI_API_KEY": "secret-openai-key", "GITHUB_TOKEN": "secret-github-token"}'
        }
    ...
    def test_load_config_missing_bucket(self):
        ...
        with patch.dict('os.environ', {}, clear=True):
            with pytest.raises(ValueError, match="REPORT_BUCKET environment variable must be set"):
                load_config()