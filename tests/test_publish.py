...
class TestSESPublisher:
    ...
    def test_send_report_success(self, mock_boto_client):
        ...
        result = publisher.send_report(
            "# Test Report", ["user1@example.com", "user2@example.com"], date
        )
...
class TestPublishReport:
    ...
    def test_publish_report_success(
        self, mock_generator, mock_s3_publisher, sample_papers
    ):
        ...
        result = publish_report(
            papers=sample_papers, intro="Test intro", bucket_name="test-bucket"
        )
    ...
    @patch("src.ai_weekly.publish.S3Publisher")
    @patch("src.ai_weekly.publish.MarkdownGenerator")
    def test_publish_report_with_email(
        self, mock_generator, mock_s3_publisher, mock_ses_publisher, sample_papers
    ):
