...
class TestRankPapers:
    ...
    def test_ranking_order(self):
        ...
        high_citation_paper = Paper(
            id="high", title="High Citations", authors=[], abstract="",
            published_date=datetime.now(), url="", source="arxiv", categories=[],
            citation_count=1000, github_stars=0
        )
        
        low_citation_paper = Paper(
            id="low", title="Low Citations", authors=[], abstract="",
            published_date=datetime.now(), url="", source="arxiv", categories=[],
            citation_count=10, github_stars=0
        )
