...
from src.ai_weekly.enrich import (
...
class TestEnrichPapers:
    ...
    def test_enrich_papers_success(self, mock_gh_enricher, mock_s2_enricher, sample_papers):
    ...
    @patch('src.ai_weekly.enrich.SemanticScholarEnricher')
    @patch('src.ai_weekly.enrich.GitHubEnricher')
    def test_enrich_papers_no_keys(self, mock_gh_enricher, mock_s2_enricher, sample_papers):
