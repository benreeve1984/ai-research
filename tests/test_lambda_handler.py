...
class TestLambdaHandler:
    ...
    def test_lambda_handler_success(self, sample_papers, mock_config):
        ...
        with patch(
            "src.ai_weekly.lambda_handler.load_config", return_value=mock_config
        ), patch(
            "src.ai_weekly.lambda_handler.harvest_papers", return_value=sample_papers
        ), patch(
            "src.ai_weekly.lambda_handler.enrich_papers", return_value=sample_papers
        ), patch(
            "src.ai_weekly.lambda_handler.rank_papers", return_value=sample_papers[:3]
        ), patch(
            "src.ai_weekly.lambda_handler.summarize_papers",
            return_value=(sample_papers[:3], "Test intro"),
        ), patch(
            "src.ai_weekly.lambda_handler.publish_report",
            return_value={
    ...
    def test_lambda_handler_config_error(self):
        ...
        with patch(
            "src.ai_weekly.lambda_handler.load_config",
    ...
    def test_lambda_handler_harvest_error(self, mock_config):
        ...
        with patch(
            ...
            "src.ai_weekly.lambda_handler.harvest_papers",
            side_effect=Exception("Harvest error"),
        ):
    ...
    def test_lambda_handler_openai_backend(self, sample_papers, mock_config):
        ...
        with patch(
            ...
            "src.ai_weekly.lambda_handler.publish_report", return_value={}
        ):
