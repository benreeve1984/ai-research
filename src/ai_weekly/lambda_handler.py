...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    logger.info("Starting AI Weekly pipeline execution", extra={
        "event": event,
    ...
    try:
        ...
        logger.info("Configuration loaded", extra={
            ...
            "subscribers_count": len(config.subscribers) if config.subscribers else 0
        })
        ...
        logger.error("Pipeline execution failed", extra={
            "error": str(e),
