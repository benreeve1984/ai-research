...
class ArxivHarvester:
    ...
    def _fetch_category_papers(self, category: str, cutoff_date: datetime) -> List[Paper]:
        ...
        try:
            ...
            for entry in feed.entries:
                ...
                try:
                    ...
                    published_date = datetime.strptime(entry.published[:19], "%Y-%m-%dT%H:%M:%S")
        ...
        try:
            ...
            for item in data.get("results", []):
                ...
                try:
                    ...
                    paper_date = paper_date.replace(tzinfo=None)  # Remove timezone for consistency
                except ValueError:
                    continue
