...
"""
        ...
        for i, paper in enumerate(papers, 1):
            ...
            markdown += f"**Published:** {paper.published_date.strftime('%Y-%m-%d')}  \n"
...
class SESPublisher:
    ...
    def send_report(self, markdown_content: str, recipients: List[str], date: datetime) -> bool:
...
def publish_report(papers: List[Paper], 
                  intro: str,
                  bucket_name: str,
